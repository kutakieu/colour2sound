...
def main():
    ...
    librosa.output.write_wav('download_reconstruct1.wav', data, rate)
    data = butter_bandpass_filter(data, lowcut, highcut, rate, order=1)
    librosa.output.write_wav('download_reconstruct2.wav', data, rate)
    ...
    # print(inverted_mel_audio[-200:])
    # inverted_mel_audio = inverted_mel_audio.astype("float32")
    print(max(inverted_mel_audio))
    print(min(inverted_mel_audio))
    ma = max(inverted_mel_audio)
    mi = min(inverted_mel_audio)
    if ma + mi > 0:
        norm = 1 / ma * 0x8000
    else:
        norm = 1 / mi * -0x8000
    ...
    # print(inverted_mel_audio[:10])
    # print(max(inverted_mel_audio))
    # print(inverted_mel_audio.shape)
    # print(type(inverted_mel_audio))
